...
<ul className="flex space-x-8 text-white">
  ...
  <div className="max-w-7xl mx-auto h-auto px-4">
    ...
    <Image src="/Clip path group.png" alt="circle" height={350} width={350} className=" absolute left-[40%] top-[2160px] z-[1] "></Image>
    ...
    <h2 className=" mt-[150px] text-white text-4xl md:text-4xl tracking-[1px] leading-tight mb-4">Making Studying More Productive</h2>
    <h3 className=" ml-[50px] mt-[75px] text-[24px] w-[60%] z-20">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</h3>
  </div>
</section>

<Image src="/image-3.png" alt="screenshot" width={400} height={1000} className=" relative left-[75%] bottom-[500px] opacity-88 z-10 "></Image>
    <Image src="/Screenshot 2024-11-29 at 2.56.17 PM 1.png" alt="screen" width={510} height={180} className=" relative left-[0%] bottom-[490px] z-10 "></Image>
    <Image src="/Screenshot 2024-11-29 at 2.57.55 PM 1.png" alt="screen" width={628} height={180} className=" relative left-[28%] bottom-[725px] "></Image>
    <Image src="/Screenshot 2024-11-29 at 2.59.28 PM 1.png" alt="screen" width={300} height={250} className=" relative left-[59%] bottom-[975px] "></Image>
    <Image src="/Screenshot 2024-11-29 at 3.01.29 PM 2.png" alt="screen" width={400} height={800} className=" relative left-[73%] z-10 bottom-[1270px] "></Image>
    <Image src="/Screenshot 2024-11-29 at 3.04.40 PM 1.png" alt="screen" width={300} height={600} className=" relative left-[82.2%] overflow-hidden z-0 bottom-[1670px] "></Image>
    <Image src="/Rectangle 11.png" alt="screen" width={5000} height={180} className=" relative left-[0%] bottom-[2000px] z-10 "></Image>
    <section className="relative bottom-[2000px] text-white py-16 px-8">
