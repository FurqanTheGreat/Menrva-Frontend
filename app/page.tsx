      ...
      >
        ...
        <div className="relative top-[100px] z-10 flex text-[white] flex-col px-6 py-12 mb-[200px]">
          ...
          <Image
            ...
            width={700}
            height={700}
            className="bottom-[200px] absolute left-[60%]"
          ></Image>
      ...
      <section className="bg-black py-16 h-auto text-white">
        <div className="max-w-7xl mx-auto h-auto px-4">
          ...
          <div className="mt-[100px] grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card text="Helping Students Progress" imageSrc="/image.png" className="" />
              <Card text="Supplement, NOT replacement" imageSrc="/image-1.png" className="bottom-[50px]" />
              <Card text="Supplement, NOT replacement" imageSrc="/image (2).png" className="bottom-[90px]" />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
            ...
            {'"'}Menrva has completely changed how I study. Uploading my notes and
              having the AI tutor guide me step-by-step has been a game-changer.
              I feel more confident in my exams now!{'"'}
            </p>
          ...
          <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
            <p className="mb-4">
              {'"'}As a working professional, I struggled to find time for
              structured learning. Menrva{"'"}s personalized approach lets me learn
              on my own schedule, and the AI tutor feels like a real
              instructor.{'"'}
            </p>
            <p className="font-semibold">
              — John D., Software Engineer (Google)
            </p>
            <div className="flex mt-4">
              <span className="text-yellow-400">★★★★★</span>
            </div>
          ...
          <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
            ...
            {'"'}I used Menrva to prepare for my university entrance exams. The
              insights and detailed explanations it provided made even the
              hardest topics easier to understand. Highly recommended!{'"'}
            </p>
            <p className="font-semibold">
              — Sana A., University Applicant (MIT)
            </p>
            <div className="flex mt-4">
              <span className="text-yellow-400">★★★★★</span>
            </div>
