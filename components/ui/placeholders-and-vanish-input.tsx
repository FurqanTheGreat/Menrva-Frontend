...
export function PlaceholdersAndVanishInput({
  ...
  return (
    <form
      className={cn(
        "w-full relative max-w-xl mx-auto bg-zinc-800 h-[120px]  rounded-[20px] overflow-hidden shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),_0px_1px_0px_0px_rgba(25,28,33,0.02),_0px_0px_0px_1px_rgba(25,28,33,0.08)] transition duration-200",
        value && "bg-zinc-800"
      )}
    ...
    >
      ...
      <input
        ...
        type="text"
        className={cn(
          "w-full relative text-sm sm:text-base z-50 border-none text-white bg-transparent  h-1/2 rounded-full focus:outline-none focus:ring-0 pl-4 pr-20",
      ...
      <div className="absolute inset-0 flex top-[15%] rounded-full pointer-events-none">
